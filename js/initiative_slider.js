            $(function() {
				...
				*/
				function showControls(){
					$('#msg_controls').stop().animate({'right':'15px','opacity':'1'},500);
				}
				function hideControls(){
					$('#msg_controls').stop().animate({'right':'-110px','opacity':'0'},500);
				}
				...
				*/
				function next(){
					...
					//if($("#initiatives").hasClass("active")){
						++current;
						showImage('r');
					//}
				}
				...
				*/
				function showImage(dir){
					...
					*/
					...
					var $to_location=$thumb.attr("href");
						...
						if($currentImage.length){
							$currentImage.fadeOut(function(){
								...
								$('<img />').load(function(){
									...
									//resize($image);
									$image.hide();
									//$('#msg_wrapper').empty().append("<a href=\""+$to_location+"\"></a>");
									$('#msg_wrapper').empty().append("<a href=\""+$to_location+"\" target=\"_blank\"></a>");
									$('#msg_wrapper a').append($image.fadeIn()).each(function(){
							...
							$('<img />').load(function(){
									...
									//resize($image);
									$image.hide();
									//$('#msg_wrapper').empty().append("<a href=\""+$to_location+"\" onclick(\"myalertfunction(event)\")></a>");
									$('#msg_wrapper').empty().append("<a href=\"#initiative_details\" onclick(\"alert(\"hello\")\")></a>");
									$('#msg_wrapper a').append($image.fadeIn()).each(function(){
										}
									)
							}).attr('src',source);
